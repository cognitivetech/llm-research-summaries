...
## Models Review
- [Shiksha A Technical Domain focused Translation Dataset and Model for Indian Languages](models-review/Shiksha-A-Technical-Domain-focused-Translation-Dataset-and-Model-for-Indian-Languages.md)
- [A Comprehensive Survey and Guide to Multimodal Large Language Models in Vision-Language Tasks](models-review/A-Comprehensive-Survey-and-Guide-to-Multimodal-Large-Language-Models-in-Vision-Language-Tasks.md)
- [Deepseek The Quiet Giant Leading China's AI Race](models-review/Deepseek-The-Quiet-Giant-Leading-China's-AI-Race.md)
- [OpenAI o1 System Card](models-review/OpenAI-o1-System-Card.md)
- [Why Worry About Incorrigible Claude](models-review/Why-Worry-About-Incorrigible-Claude.md)
- [Number of Parameters in GPT-4 (Latest Data)](models-review/Number-Parameters-in-GPT-4-Latest-Data.md)
...
## Training
- (2025-01) [Analyzing Fine-tuning Representation Shift for Multimodal LLMs Steering](training/Analyzing-Fine-tuning-Representation-Shift-for-Multimodal-LLMs-Steering_2501.03012v1.md)
- (2024-12) [Safeguard Fine-Tuned LLMs Through Pre- and Post-Tuning Model Merging](training/Safeguard-Fine-Tuned-LLMs-Through-Pre--and-Post-Tuning-Model-Merging_2412.19512v1.md)
- (2024-10) [SLIM: Let LLM Learn More and Forget Less with Soft LoRA and Identity Mixture](training/SLIM-Let-LLM-Learn-More-and-Forget-Less-with-Soft-LoRA-and-Identity-Mixture_2410.07739.md)
- (2024-10) [LoRA vs Full Fine-tuning: An Illusion of Equivalence](training/LoRA-vs-Full-Fine-tuning-Illusion-Equivalence_2410.21228v1.md)
- (2024-05) [LoRA Learns Less and Forgets Less](training/LoRA_Learns-Less-Forgets-Less_2405.09673.md)
- (2024-10) [LoRA Done RITE: Robust Invariant Transformation Equilibration for LoRA Optimization](training/LoRA-Done-RITE_Robust-Invariant-Transformation-Equilibration_2410.20625v1.md)
- (2024-01) [Chain of LoRA: Efficient Fine-tuning of Language Models via Residual Learning](training/Chain-of-Lora_Residual-Learning_2401.04151.md)
- (2024-02) [BitDelta: Your Fine-Tune May Only Be Worth One Bit](training/BitDelta_Your-Fine-Tune-May-Only-Be-Worth-One-Bit_2402.10193v3.md)
- (2024-08) [BA-LoRA: Bias-Alleviating Low-Rank Adaptation to Mitigate Catastrophic Inheritance in Large Language Models](training/Bias-Alleviating-Low-Rank-Adaptation-to-Mitigate-Catastrophic-Inheritance-in-Large-Language-Models_2408.04556.md)
- (2024-04) [Inheritune: Training Smaller Yet More Attentive Language Models](training/inheritune-Smaller-Yet-More-Attentive-Language-Models-2404.08634.md)
- (2024-10) [InfiniPot: Efficiently Handling Long Input Contexts in Large Language Models (LLMs) on Memory-Constrained Devices](training/InfiniPot-Efficiently-Handling-Long-Input-Contexts_LLM_Memory-Constrained-Devices-2410.01518.md)
- (2024-09) [Propulsion: Steering LLM with Tiny Fine-Tuning](training/propultion-tiny-finetune-2409.10927.md)
- (2024-09) [Finetuning LLMs for Comparative Assessment Tasks](training/Comparative-Assesment-2409.15979.md)
- (2024-08) [Ultimate Guide to Fine-Tuning LLMs: From Basics to Breakthroughs](training/ultimate-guide-fine-tuning-llm_parthasarathy-2408.13296.md)
- (2024-03) [Tune without Validation Searching for Learning Rate and Weight Decay on Training Sets](training/Tune-without-Validation-Searching-for-Learning-Rate-and-Weight-Decay-on-Training-Sets_2403.05532v1.md)
...
- [HunyuanProver A Scalable Data Synthesis Framework and Guided Tree Search for Automated Theorem Proving](code-tools/HunyuanProver-A-Scalable-Data-Synthesis-Framework-and-Guided-Tree-Search-for-Automated-Theorem-Proving.md)
- [MCP-Solver Integrating Language Models with Constraint Programming Systems](code-tools/MCP-Solver-Integrating-Language-Models-with-Constraint-Programming-Systems.md)
...
- [Artificial Intelligence Applications for Social Science Research](social-science/AI-Tools-for-Social-Scientists.md) [Research Tools]
- [Evaluating LLMs Capabilities Towards Understanding Social Dynamics](social-science/Evaluating-LLMs-Capabilities-Towards-Understanding-Social-Dynamics.md)
- [Automated Social Science: Language Models as Scientist and Subjects](social-science/Social-Science_Scientist-Subjects.md)
- [Large Language Models based on historical text could offer informative tools for behavioral science](social-science/LLM-of-historical-text-for-behavioral-science.md) [History] [Behavioral-Science]
- [PropaInsight: Toward Deeper Understanding of Propaganda in Terms of Techniques, Appeals, and Intent](social-science/PropaInsight-Toward-Deeper-Understanding-of-Propaganda.md) [Social-Psychology]
- [Autoformalization of Game Descriptions using Large Language Models](social-science/autoformalize-game-descriptions.md) [Game-Theory]

### AI Psychology
- [Large Language Models Reflect the Ideology of their Creators](social-science/ai-psychology/Large-Language-Models-Reflect-the-Ideology-of-their-Creators.md)
- [Can a Large Language Model be a Gaslighter?](social-science/ai-psychology/Can-a-Large-Language-Model-be-a-Gaslighter.md)
- [Evaluating Psychological Safety of Large Language Models](social-science/ai-psychology/Evaluating-Psychological-Safety-of-Large-Language-Models.md)
- [Measuring Human and AI Values based on Generative Psychometrics with Large Language Models](social-science/ai-psychology/measuring-values_human-ai.md)
- [Large Language Models and Cognitive Science: A Comprehensive Review of Similarities, Differences, and Challenges](social-science/ai-psychology/LLM-and-Cognitive-Science_Comprehensive-Review.md)

### Mental Health
- [The Emotional Spectrum of LLMs Leveraging Empathy and Emotion-Based Markers for Mental Health Support](social-science/mental-health/The-Emotional-Spectrum-of-LLMs-Leveraging-Empathy-and-Emotion-Based-Markers-for-Mental-Health-Support.md)- [MentalArena: Self-play Training of Language Models for Diagnosis and Treatment of Mental Health Disorders](social-science/mental-health/MentalArena-Self-play-Training-Language-Models-Diagnosis-Treatment-Mental-Health-Disorders.md) [Diagnosis-Treatment]
- [Severity Prediction in Mental Health: LLM-based Creation, Analysis, Evaluation of a Novel Multilingual Dataset](social-science/mental-health/Severity-Prediction-in-Mental-Health.md)
- [A COMPREHENSIVE EVALUATION OF LARGE LANGUAGE MODELS ON MENTAL ILLNESS](social-science/mental-health/mental-health-llm-survey.md)
- [DISCO: A Hierarchical Disentangled Cognitive Diagnosis Framework for Interpretable Job Recommendation](social-science/mental-health/DISCO-Cognitive-Diagnosis-Framework-for-Interpretable-Job-Recommendation.md)
- [Mapping neurotransmitter systems to the structural and functional organization of the human neocortex](social-science/mental-health/Mapping-neurotransmitter-systems-to-the-structural-and-functional-organization-of-the-human-neocortex.md) [Neural-Correlates]

### Types Predict
- [Myers-Briggs Personality Type Prediction Based on Reddit Comments](social-science/types-predict/Personality_Prediction_Based_on_Reddit_Comments.md) [MBTI]
- [Machine Mindset: An MBTI Exploration of Large Language Models](social-science/types-predict/Machine-Mindset_MBTI.md) [MBTI]
...
## Future Perspectives
- [Beware the Intention Economy Collection and  Commodification of Intent via Large Language Models](future-perspectives/Beware-the-Intention-Economy-Collection-and-Commodification-of-Intent-via-Large-Language-Models.md)
